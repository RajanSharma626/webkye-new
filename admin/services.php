...
<head>
    ...
    <title>Services | Webkye.in</title>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div>
                                    <a href="add-service" class="btn btn-success" id="addproduct-btn"><i
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_assoc($sql)) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle" >
                                                    <img src="../assets/img/services/<?php echo $row['img'] ?>" class="img-fluid" width="50px" alt="">
                                                </td>
                                                <td class="align-middle" >
                                                ...
                                                <td class="align-middle" >
                                                    <ul class="hstack gap-2 list-unstyled mb-0">
                                                        <li>
                                                            <a href="add-service?id=<?php echo $row['id'] ?>"
