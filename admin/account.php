                    ...
                    <div class="row">
                        <div class="col-xxl-9">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9">
                                            <div
                                                class="d-flex border-bottom border-bottom-dashed pb-3 mb-3 mt-4 mt-lg-0">
                                                        ...
                                                        <table class="table table-borderless table-sm mb-0">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="fw-medium">
                                                                        <i
                                                                            class="bi bi-star-half text-warning align-middle me-1"></i>
                                                                        365
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                            ...
                            <div class="d-flex align-items-center flex-wrap gap-3 mb-4">
                                ...
                                <div class="flex-shrink-0">
                                    <a href="account-settings.html" class="btn btn-success">Profile Settings</a>
                                </div>
                            </div>
                            <!-- Tab panes -->
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                                ...
                                                <table class="table align-middle table-nowrap">
                                                    <thead class="table-light">
                                                        <tr>
                                                            ...
                                                            <th class="fw-medium" data-sort="product_name">Product Name
                                                            </th>
                                                            <th class="fw-medium" data-sort="amount">Amount</th>
                                                            <th class="fw-medium" data-sort="order_date">Order Date</th>
                                                            <th class="fw-medium" data-sort="payment_method">Payment
                                                                Method</th>
                                                            <th class="fw-medium" data-sort="status">Delivery Status
                                                            </th>
                                                    ...
                                                    <tbody class="list form-check-all">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="status">
                                                                <span
                                                                    class="badge bg-info-subtle text-info ">Pickups</span>
                                                            </td>
                                                            <td>
                                                                <div class="dropdown">
                                                                    <button
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="status">
                                                                <span
                                                                    class="badge bg-secondary-subtle text-secondary ">Inprogress</span>
                                                            </td>
                                                            <td>
                                                                <div class="dropdown">
                                                                    <button
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="status">
                                                                <span
                                                                    class="badge bg-primary-subtle text-primary ">Returns</span>
                                                            </td>
                                                            <td>
                                                                <div class="dropdown">
                                                                    <button
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="status">
                                                                <span
                                                                    class="badge bg-danger-subtle text-danger ">Cancelled</span>
                                                            </td>
                                                            <td>
                                                                <div class="dropdown">
                                                                    <button
                                            ...
                                            <div class="row g-0 text-center text-md-start align-items-center">
                                                <div class="col-md-6">
                                                    <div>
                                                        <p class="mb-md-0">Showing <b>1</b> to <b>10</b> of <b>18</b>
                                                            entries</p>
                                                    </div>
                                                </div> <!-- end col -->
                                                <div class="col-md-6">
                                                    <ul
                                                        ...
                                                        <li class="page-item disabled"> <a href="#" class="page-link"><i
                                                                    class="mdi mdi-chevron-left align-middle me-1"></i>
                                                                Previous</a> </li>
                                                        ...
                                                        <li class="page-item"> <a href="#" class="page-link">Next <i
                                                                    class="mdi mdi-chevron-right align-middle ms-1"></i></a>
                                                        </li>
                                                    </ul>
                                                </div><!-- end col -->
                                            </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                                ...
                                                <table class="table align-middle table-nowrap">
                                                    ...
                                                    <tbody class="list form-check-all">
                                                        <tr>
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <div class="flex-shrink-0 me-2 avatar-sm">
                                                                        <div class="avatar-title bg-light rounded"> <img
                                                                                ...
                                                                                alt="" class="avatar-xs"> </div>
                                                                    </div>
                                                                    <div class="flex-grow-1">
                                                                        <h6 class="mb-1"><a href="product-overview.html"
                                                                                class="d-block text-dark">World's most
                                                                                expensive t shirt</a></h6>
                                                            ...
                                                            <td class="rate">
                                                                <span
                                                                    class="badge bg-light text-body fs-13 fw-medium"><i
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="product_name">
                                                                <div class="d-flex align-items-center">
                                                                    <div class="flex-shrink-0 me-2 avatar-sm">
                                                                        <div class="avatar-title bg-light rounded"> <img
                                                                                src="../assets/images/products/img-15.png"
                                                                                alt="" class="avatar-xs"> </div>
                                                                    </div>
                                                                    <div class="flex-grow-1">
                                                                        <h6 class="mb-1"><a href="product-overview.html"
                                                                                class="d-block text-dark">Like Style
                                                                                Women Black Handbag</a></h6>
                                                                        <p class="mb-0 text-muted">Category : <span
                                                                                class="fw-medium">Other
                                                                                Accessories</span></p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="product_name">
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="flex-grow-1">
                                                                        <h6 class="mb-1"><a href="product-overview.html"
                                                                                class="d-block text-dark">Black Horn
                                                                                Backpack For Men Bags 30 L Backpack</a>
                                                                        </h6>
                                                                        <p class="mb-0 text-muted">Category : <span
                                                                                class="fw-medium">Other
                                                                                Accessories</span></p>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="product_name">
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="flex-grow-1">
                                                                        <h6 class="mb-1"><a href="product-overview.html"
                                                                                class="d-block text-dark">Innovative
                                                                                education book</a></h6>
                                                                        <p class="mb-0 text-muted">Category : <span
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="product_name">
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="flex-grow-1">
                                                                        <h6 class="mb-1"><a href="product-overview.html"
                                                                                class="d-block text-dark">Sangria Girls
                                                                                Mint Green & Off-White Toe Flats</a>
                                                                        </h6>
                                                                        <p class="mb-0 text-muted">Category : <span
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="product_name">
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="flex-grow-1">
                                                                        <h6 class="mb-1"><a href="product-overview.html"
                                                                                class="d-block text-dark">Striped High
                                                                                Neck Casual Men Orange Sweater</a></h6>
                                                                        <p class="mb-0 text-muted">Category : <span
                                                                                class="fw-medium">Fashion</span></p>
                                                                    </div>
                                                                </div>
                                            ...
                                            <div class="row g-0 text-center text-md-start align-items-center">
                                                <div class="col-md-6">
                                                    <div>
                                                        <p class="mb-md-0">Showing <b>1</b> to <b>6</b> of <b>18</b>
                                                            entries</p>
                                                    </div>
                                                </div> <!-- end col -->
                                                <div class="col-md-6">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                                ...
                                                <table class="table align-middle table-nowrap" id="customerTable">
                                                    ...
                                                    <tbody class="list form-check-all">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="to">HDFC</td>
                                                            <td class="timestamp">29 Jan, 2023 <small
                                                                    class="text-muted">03:20PM</small></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="to">HDFC</td>
                                                            <td class="timestamp">29 Jan, 2023 <small
                                                                    class="text-muted">04:33PM</small></td>
                                                            <td class="payment_method">Credit Card</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="to">Admin</td>
                                                            <td class="timestamp">17 Jan, 2023 <small
                                                                    class="text-muted">01:35AM</small></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="to">Admin</td>
                                                            <td class="timestamp">29 Dec, 2022 <small
                                                                    class="text-muted">11:49AM</small></td>
                                                            <td class="payment_method">Debit Card</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="timestamp">13 Dec, 2022 <small
                                                                    class="text-muted">10:30AM</small></td>
                                                            <td class="payment_method">PayPal</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="from">Admin</td>
                                                            <td class="to">HDFC</td>
                                                            <td class="timestamp">11 Dec, 2022 <small
                                                                    class="text-muted">09:46PM</small></td>
                                                            <td class="payment_method">Online Banking</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="timestamp">02 Nov, 2022 <small
                                                                    class="text-muted">07:30PM</small></td>
                                                            <td class="payment_method">PayPal</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="to">Admin</td>
                                                            <td class="timestamp">29 Oct, 2022 <small
                                                                    class="text-muted">12:58AM</small></td>
                                                            <td class="payment_method">Credit Card</td>
                                            ...
                                            <div class="row g-0 text-center text-md-start align-items-center">
                                                <div class="col-md-6">
                                                    <div>
                                                        <p class="mb-md-0">Showing <b>1</b> to <b>10</b> of <b>27</b>
                                                            entries</p>
                                                    </div>
                                                </div> <!-- end col -->
                                                <div class="col-md-6">
                                                ...
                                                <div class="acitivity-timeline acitivity-main">
                                                    <div class="acitivity-item d-flex">
                                                        ...
                                                        <div class="flex-grow-1 ms-3">
                                                            ...
                                                            <p class="text-muted mb-0">Product noise evolve smartwatch
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div class="acitivity-item py-3 d-flex">
                                                        ...
                                                        <div class="flex-grow-1 ms-3">
                                                            <h6 class="mb-0 lh-base">Today offers by <a
                                                                    href="seller-overview.html"
                                                                    class="link-secondary">themesbrand</a></h6>
                                                            <p class="mb-2 text-muted"><small>03:14 PM - 18 Jan,
                                                                    2023</small></p>
                                                            <p class="text-muted mb-0">Offer is valid on orders of
                                                    ...
                                                    <div class="acitivity-item py-3 d-flex">
                                                        ...
                                                        <div class="flex-grow-1 ms-3">
                                                            <h6 class="mb-0 lh-base">Added new <span
                                                                    class="fw-semibold">style collection</span></h6>
                                                            <p class="mb-2 text-muted"><small>9:47 PM Yesterday</small>
                                                            </p>
                                                    ...
                                                    <div class="acitivity-item py-3 d-flex">
                                                        ...
                                                        <div class="flex-grow-1 ms-3">
                                                            <h6 class="mb-0 lh-base">Alina Holland have bookmark the
                                                                products</h6>
                                                            <p class="mb-2 text-muted"><small>04:30 AM - 29 Dec,
                                                                    2022</small></p>
                                                            <p class="text-muted mb-0">Allow users to bookmark products
                                                                in your WooCommerce store.</p>
                                                        </div>
                                                    </div>
                                                    <div class="acitivity-item py-3 d-flex">
                                                        <div class="flex-shrink-0">
                                                        ...
                                                        <div class="flex-grow-1 ms-3">
                                                            ...
                                                            <p class="mb-2 text-muted"><small>01:14 PM - 24 Nov,
                                                                    2022</small></p>
                                                            <p class="text-muted mb-0">Kristina Hooper have favorites
                                                                product.</p>
                                                        </div>
                                                    </div>
                                                    <div class="acitivity-item py-3 d-flex">
                                                        ...
                                                        <div class="flex-grow-1 ms-3">
                                                            ...
                                                            <p class="mb-2 text-muted"><small>11:15 AM - 29 Oct,
                                                                    2022</small></p>
                                                            <p class="text-muted mb-0">Flash sale by <a
                                                                    href="javascript:void(0);"
                                                                    class="link-secondary fw-medium">Terry & Jerry
                                                                    Fashion</a></p>
                                                        </div>
                                                    </div>
                                                    <div class="acitivity-item py-3 d-flex">
                                                        ...
                                                        <div class="flex-grow-1 ms-3">
                                                            ...
                                                            <p class="mb-2 text-muted"><small>04:57 PM - 11 Sep,
                                                                    2022</small></p>
                                                            <p class="text-muted mb-0"><span class="text-danger">1 days
                                                    ...
                                                    <div class="acitivity-item d-flex">
                                                        ...
                                                        <div class="flex-grow-1 ms-3">
                                                            ...
                                                            <p class="mb-2 text-muted"><small>04:57 PM - 26 Aug,
                                                                    2022</small></p>
                                                            ...
                                                            <p class="text-muted mb-0 fst-italic">" A product that has
                                                ...
                                                <div class="swiper-wrapper">
                                                    <div class="swiper-slide">
                                                        <div class="p-3 bg-secondary bg-opacity-10 rounded">
                                                            <p class="mb-2 text-truncate-three-lines">Thanks to the
                                                                pandemic, e-commerce has seen a surge of activity and
                                                                new consumers. This projection is based on the fact that
                                                                the sector is expected to grow at 20 percent annually.
                                                            </p>
                                                            <div class="text-end">
                                                    ...
                                                    <div class="swiper-slide">
                                                        <div class="p-3 bg-primary bg-opacity-10 rounded">
                                                            <p class="mb-2 text-truncate-three-lines">Live shopping
                                                                could be a great innovation to consider as part of your
                                                                strategy in 2022 to further build customer engagement,
                                                                loyalty</p>
                                                            <div class="text-end">
                                                    ...
                                                    <div class="swiper-slide">
                                                        <div class="p-3 bg-danger bg-opacity-10 rounded">
                                                            <p class="mb-2 text-truncate-three-lines">Buying online has
                                                                become necessary for some customers, especially if they
                                                                are part of the at-risk groups.</p>
                                                            <div class="text-end">
                                                                <a href="#!" class="link-danger"><i>- Sales
                                                                        Manager</i></a>
                                                            </div>
                                                        </div>
                                                    </div>
...
<!-- Mirrored from themesbrand.com/toner/html/backend/account.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Oct 2023 16:32:55 GMT -->
