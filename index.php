...
<body>
  ...
  <!--  Start Banner -->
  <section class="banner banner_1 overflow-hidden position-relative">
    ...
    <!-- <div>
      <img src="assets/img/banner/bg_shap1.png" alt="alt" class="bg__shap_1">
    </div> -->
  ...
  <!--  Start About 1 -->
  <section class="about_1 py__150 overflow-hidden" id="about">
    <div class="container">
      <div class="row">
        <div class="col-xl-7 col-lg-5">
          <img src="assets/img/about/about.jpg" alt="alt" class="about__img" />
        </div>
        <div class="col-xl-5 col-lg-7 position-relative">
          <div>
            <div>
              <!-- Title srart-->
              ...
              <p class="pt__35">
                ...
                We're all about fresh ideas and killer results. Wanna join
                forces and skyrocket your brand in the digital world? We got
                this!
              </p>
            </div>
            <!-- Title srart-->
            <div class="pt__30">
              ...
              <div>
                ...
                <!-- <p>
                    ...
                    campaigns for themselves. This includes creating compelling
                    ad.
                  </p> -->
              </div>
              <div class="pt__30">
    ...
    <div>
      <!-- shap start -->
      <img src="assets/icons/circle.png" alt="" class="circle__shap" data-aos="fade-up" data-aos-delay="100"
        data-aos-offset="0" data-aos-duration="1000" />
      <img src="assets/icons/rat_agal.png" alt="" class="rat_agal d-none d-xl-block" data-aos="fade-up"
        data-aos-delay="100" data-aos-offset="0" data-aos-duration="1000" />
      <img src="assets/icons/star.png" alt="" class="star__shap d-none d-xl-block" data-aos="fade-up"
        data-aos-delay="100" data-aos-offset="0" data-aos-duration="1000" />
    </div>
    <!-- shap end -->
  </section>
      ...
      <div>
        <div class="partner__wapper">
          <div class="partner__content">
            <div class="slide">
              <img src="assets/img/about/cmp1.svg" alt="alt" class="partner__logo" />
            </div>
            <div class="slide">
              <img src="assets/img/about/cmp2.svg" alt="alt" class="partner__logo" />
            </div>
            <div class="slide">
              <img src="assets/img/about/cmp3.svg" alt="alt" class="partner__logo" />
            </div>
            <div class="slide">
              <img src="assets/img/about/cmp4.svg" alt="alt" class="partner__logo" />
            </div>
            <div class="slide">
              <img src="assets/img/about/cmp5.svg" alt="alt" class="partner__logo" />
            </div>
            <div class="slide">
              <img src="assets/img/about/cmp1.svg" alt="alt" class="partner__logo" />
            </div>
  ...
  <!--  Start Services 1 -->
  <section class="services_1 py__130 overflow-x-hidden" id="services">
    <div class="container position-relative">
      <!-- Title start -->
      <div class="text-center title__area">
        <p class="transparent__btn">Services</p>
        <h2 class="t__40 pt__30">
          What Services We Provide For Your Business
        </h2>
      </div>
      <!-- Title end -->
    ...
    <div>
      <!-- shap start -->
      <img src="assets/icons/star.png" alt="" class="star__shap" data-aos="fade-up" data-aos-delay="100"
        data-aos-offset="0" data-aos-duration="1000" />
      <img src="assets/icons/half_circle.png" alt="" class="half__circle_shap d-none d-xl-block" data-aos="fade-up"
        data-aos-delay="100" data-aos-offset="0" data-aos-duration="1000" />
    </div>
    <!-- shap end -->
  </section>
  ...
  <!--  Start choose us -->
  <section class="choose overflow-hidden py__150">
    <div class="container">
      <div class="row">
        <div class="col-lg-7">
          <!-- Title and choose list start-->
          <div>
            <!-- Title start -->
            <div class="title__area">
              <div class="transparent__btn">Why Choose Webkye</div>
              <h2 class="t__40 pt__30">
                We empower your business to achieve greater strength and growth.
              </h2>
              <p class="pt__35">
                Why choose WebKye Digital Marketing Agency? Because we turn
                online ambitions into thriving realities with our expertise
                and dedication.
              </p>
            </div>
            <!-- Title end -->
            ...
            <div class="feature">
              <!-- award start -->
              <!-- <div class="d-xl-flex justify-content-between align-items-center gap-5">
                <div class="d-flex align-items-center gap-3">
                  <div><img src="assets/img/choose/award1.png" alt="" /></div>
                  <h3 class="t__22">World Marketing Wining Awards 2024</h3>
                </div>
                <div class="d-flex align-items-center gap-3 mt-4 mt-xl-0">
                  <div><img src="assets/img/choose/award2.png" alt="" /></div>
                  <h3 class="t__22">
                    Retail Marketing Innovation Awards 2024
                  </h3>
                </div>
              </div> -->
              <!-- award End -->
              ...
              <div>
                <div class="d-flex gap-4">
                  <!-- list start -->
                  <div><img src="assets/img/choose/check.png" alt="" /></div>
                  <p>
                    <b>All-in-One Solutions:</b> Digital marketing, web development, design, video editing, and SEO -
                    WebKye
                    covers it all, streamlining your online presence.
                  </p>
                </div>
                <!-- list end -->

                <div class="d-flex gap-4 pt__30">
                  <!-- list start -->
                  <div><img src="assets/img/choose/check.png" alt="" /></div>
                  <p>
                    <b>Tailored Strategies:</b> We understand your unique needs and craft customized solutions to
                    elevate your
                ...
                <div class="d-flex gap-4 pt__30">
                  ...
                  <div><img src="assets/img/choose/check.png" alt="" /></div>
                  <p>
                    <b>Innovation and Excellence:</b> WebKye employs cutting-edge techniques and best practices to keep
                    your
                    brand ahead in the digital game.
                  </p>
                </div>
                <!-- list end -->
              </div>
        ...
        <!-- Title and choose list end-->
        <div class="col-lg-5">
          <img src="assets/img/choose/bg_img.png" alt="" class="bg__img" />
          <!-- bg image-->
        </div>
      </div>
    </div>
    ...
    <div>
      <!-- shap start-->
      <img src="assets/icons/dots.png" alt="" class="dots__shap d-none d-xl-block" data-aos="fade-up"
        data-aos-delay="100" data-aos-offset="0" data-aos-duration="1000" />
      <div data-aos="fade-up" data-aos-delay="100" data-aos-offset="0" data-aos-duration="1000">
  ...
  <!--  Start Projects 1 -->
  <section class="projects_1 overflow-hidden pb__130">
    <div class="container">
      <div class="title__area">
        <!-- Title start-->
      ...
      <div class="row mt__50">
        <div class="col-lg-6 mb-4">
          <!--  card 1 start-->
          <div class="prj__card">
            <img src="assets/img/projects/prj_1.png" alt="" />
            <div class="card__footer">
              ...
              <div>
                <h5 class="t__22">Web Development</h5>
                <p class="last">Develop</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-6 mb-4">
          <!--  card 2 start-->
          <div class="prj__card">
            <img src="assets/img/projects/prj_2.png" alt="" />
            <div class="card__footer">
              <div class="client__name">
                <small>Client</small>
                <p>Jon Deo</p>
        ...
        <div class="col-lg-6 mb-4 mb-lg-0">
          <!--  card 3 start-->
          <div class="prj__card">
            <img src="assets/img/projects/prj_3.png" alt="" />
            <div class="card__footer">
              <div class="client__name">
                <small>Client</small>
                <p>Jon Deo</p>
        ...
        <div class="col-lg-6">
          <!--  card 4 start-->
          <div class="prj__card last__card">
            <img src="assets/img/projects/prj_4.png" alt="" />
            <div class="card__footer">
              <div class="client__name">
                <small>Client</small>
                <p>Jon Deo</p>
    ...
    <div>
      <!--  shap start-->
      <img src="assets/icons/half_line.png" alt="" class="line__shap" data-aos="fade-up" data-aos-delay="100"
        data-aos-offset="0" data-aos-duration="1000" />
      <img src="assets/icons/sun_full.png" alt="" class="sun__shap" data-aos="fade-up" data-aos-delay="100"
        data-aos-offset="0" data-aos-duration="1000" />
      <img src="assets/icons/dots.png" alt="" class="dots__shap" data-aos="fade-up" data-aos-delay="100"
        data-aos-offset="0" data-aos-duration="1000" />
    </div>
    <!--  shap end-->
  </section>
  ...
  <!-- Start Work Process -->
  <section class="work_process py__130">
    <div class="container">
      <div class="wapper">
        ...
        <div>
          ...
          <div class="title__area">
            ...
            <h2 class="t__40 pt__30">
              How Our Work Process For Our Marketing Customer
            </h2>
          </div>
    ...
    <div>
      <!-- shap start-->
      <img src="assets/icons/shap1.png" alt="" class="shap__1" data-aos="fade-up" data-aos-delay="100"
        data-aos-offset="0" data-aos-duration="1000" />
      <img src="assets/icons/dots.png" alt="" class="dots__shap d-none d-xl-block" data-aos="fade-up"
        data-aos-delay="100" data-aos-offset="0" data-aos-duration="1000" />
    </div>
                ...
                <div class="content">
                  ...
                  <div class="user">
                    ...
                    <div>
                      ...
                      <p class="d-flex align-items-center"><img src="assets/img/review/<?php echo $row['country'] ?>" alt="country_flag"
                          class="avatar-sm " style="width: 20px;height: 15px; border-radius: 0;">&nbsp; USA</p>
                    </div>
                  </div>
  ...
  <section class="blogs py__130" id="blogs">
    <div class="container">
      ...
      <div class="d-lg-flex justify-content-between align-items-center">
        <div class="title__area">
          <div class="transparent__btn">Blogs & Articles</div>
          <h2 class="t__40 pt__30">
        ...
        <div class="mt-4 mt-lg-0">
          <a href="#" class="common__btn_yellow">
            View All News <i class="ti-arrow-top-right"></i></a>
        </div>
      </div>
      <!-- Title End -->
      ...
      <div class="wapper mt__50">
        <div class="blg__card">
          ...
          <div class="card__header">
            <ul class="d-flex align-items-center gap-4">
              ...
              <li><i class="fa fa-calendar"></i> 25 April, 2024</li>
            </ul>
            <h3 class="t__22">
              <a href="#">How can you start your business for your next generation</a>
            </h3>
          </div>
          <img src="assets/img/blogs/blog1.jpg" alt="" class="w-100" />
          <div class="card__footer">
            <p>
        ...
        <div class="blg__card">
          ...
          <img src="assets/img/blogs/blog2.jpg" alt="" class="w-100" />
          <div class="card__footer">
            <p>
              Digital marketing agencies run paid advertising campaigns for
              themselves.
        ...
        <div class="blg__card">
          ...
          <img src="assets/img/blogs/blog3.jpg" alt="" class="w-100" />
          <div class="card__footer">
            <p>
              Digital marketing agencies run paid advertising campaigns for
              themselves.
