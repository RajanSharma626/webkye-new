  ...
  <section class="projects_1 overflow-hidden pb__130">
    <div class="container">
      ...
      <div class="row mt__50">
        ...
        <?php
        $project = mysqli_query($conn, "SELECT * FROM `project` ORDER BY `id` DESC LIMIT 4");
        ...
        <div class="col-12 mt-4 mt-lg-0 text-center">
          <a href="portfolios" class="common__btn_yellow">
            View all <i class="ti-arrow-top-right"></i></a>
        </div>
      </div>
    </div>
