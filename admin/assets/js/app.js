! function() {
    ...
    function f() {
        var o, e = document.documentElement.getAttribute("data-layout"),
            ...
            t = JSON.parse(t);
        !t || "twocolumn" != e && "twocolumn" != t["data-layout"] || (document.querySelector(".navbar-menu") && (document.querySelector(".navbar-menu").innerHTML = u), (o = document.createElement("ul")).innerHTML = '<a href="index.html" class="logo"><img src="../assets/images/logo-sm.png" alt="" height="22"></a>', Array.from(document.getElementById("navbar-nav").querySelectorAll(".menu-link")).forEach(function(e) {
    ...
    function I() {
        var e = document.documentElement.clientWidth,
            e = (e < 1025 && 767 < e ? (document.body.classList.remove("twocolumn-panel"), "twocolumn" == sessionStorage.getItem("data-layout") && (document.documentElement.setAttribute("data-layout", "twocolumn"), document.getElementById("customizer-layout03") && document.getElementById("customizer-layout03").click(), f(), A(), h()), "vertical" == sessionStorage.getItem("data-layout") && document.documentElement.setAttribute("data-sidebar-size", "sm"), document.querySelector(".hamburger-icon") && document.querySelector(".hamburger-icon").classList.add("open")) : 1025 <= e ? (document.body.classList.remove("twocolumn-panel"), "twocolumn" == sessionStorage.getItem("data-layout") && (document.documentElement.setAttribute("data-layout", "twocolumn"), document.getElementById("customizer-layout03") && document.getElementById("customizer-layout03").click(), f(), A(), h()), "vertical" == sessionStorage.getItem("data-layout") && document.documentElement.setAttribute("data-sidebar-size", sessionStorage.getItem("data-sidebar-size")), document.querySelector(".hamburger-icon") && document.querySelector(".hamburger-icon").classList.remove("open")) : e <= 767 && (document.body.classList.remove("vertical-sidebar-enable"), document.body.classList.add("twocolumn-panel"), "twocolumn" == sessionStorage.getItem("data-layout") && (document.documentElement.setAttribute("data-layout", "vertical"), k("vertical"), h()), "horizontal" != sessionStorage.getItem("data-layout") && document.documentElement.setAttribute("data-sidebar-size", "lg"), document.querySelector(".hamburger-icon")) && document.querySelector(".hamburger-icon").classList.add("open"), document.querySelectorAll("#navbar-nav > li.nav-item"));
        Array.from(e).forEach(function(e) {
    ...
    function z(e) {
        if (e == e) {
            switch (e["data-layout"]) {
                case "vertical":
                    x("data-layout", "vertical"), sessionStorage.setItem("data-layout", "vertical"), document.documentElement.setAttribute("data-layout", "vertical"), k("vertical"), h();
                    break;
                case "horizontal":
                ...
                case "twocolumn":
                    ...
                    break;
                default:
                    "vertical" == sessionStorage.getItem("data-layout") && sessionStorage.getItem("data-layout") ? (x("data-layout", "vertical"), sessionStorage.setItem("data-layout", "vertical"), document.documentElement.setAttribute("data-layout", "vertical"), k("vertical"), h()) : "horizontal" == sessionStorage.getItem("data-layout") ? (x("data-layout", "horizontal"), sessionStorage.setItem("data-layout", "horizontal"), document.documentElement.setAttribute("data-layout", "horizontal"), k("horizontal")) : "twocolumn" == sessionStorage.getItem("data-layout") && (x("data-layout", "twocolumn"), sessionStorage.setItem("data-layout", "twocolumn"), document.documentElement.setAttribute("data-layout", "twocolumn"), k("twocolumn"))
            }
            switch (e["data-topbar"]) {
                ...
                case "dark":
                    ...
                    break;
                case "brand":
                    x("data-topbar", "brand"), sessionStorage.setItem("data-topbar", "brand"), document.documentElement.setAttribute("data-topbar", "brand");
                    break;
                default:
                    "dark" == sessionStorage.getItem("data-topbar") ? (x("data-topbar", "dark"), sessionStorage.setItem("data-topbar", "dark"), document.documentElement.setAttribute("data-topbar", "dark")) : "light" == sessionStorage.getItem("data-topbar") ? (x("data-topbar", "light"), sessionStorage.setItem("data-topbar", "light"), document.documentElement.setAttribute("data-topbar", "light")) : "brand" == sessionStorage.getItem("data-topbar") && (x("data-topbar", "brand"), sessionStorage.setItem("data-topbar", "brand"), document.documentElement.setAttribute("data-topbar", "brand"))
            }
            switch (e["data-layout-style"]) {
                ...
                case "detached":
                    ...
                    break;
                default:
                    "detached" == sessionStorage.getItem("data-layout-style") ? (x("data-layout-style", "detached"), sessionStorage.setItem("data-layout-style", "detached"), document.documentElement.setAttribute("data-layout-style", "detached")) : (x("data-layout-style", "default"), sessionStorage.setItem("data-layout-style", "default"), document.documentElement.setAttribute("data-layout-style", "default"))
            }
            switch (e["data-sidebar-size"]) {
                ...
                case "sm-hover":
                    ...
                    break;
                default:
                    "sm" == sessionStorage.getItem("data-sidebar-size") ? (document.documentElement.setAttribute("data-sidebar-size", "sm"), x("data-sidebar-size", "sm"), sessionStorage.setItem("data-sidebar-size", "sm")) : "md" == sessionStorage.getItem("data-sidebar-size") ? (document.documentElement.setAttribute("data-sidebar-size", "md"), x("data-sidebar-size", "md"), sessionStorage.setItem("data-sidebar-size", "md")) : "sm-hover" == sessionStorage.getItem("data-sidebar-size") ? (document.documentElement.setAttribute("data-sidebar-size", "sm-hover"), x("data-sidebar-size", "sm-hover"), sessionStorage.setItem("data-sidebar-size", "sm-hover")) : (document.documentElement.setAttribute("data-sidebar-size", "lg"), x("data-sidebar-size", "lg"), sessionStorage.setItem("data-sidebar-size", "lg"))
            }
            switch (e["data-bs-theme"]) {
                ...
                case "dark":
                    ...
                    break;
                default:
                    sessionStorage.getItem("data-bs-theme") && "dark" == sessionStorage.getItem("data-bs-theme") ? (sessionStorage.setItem("data-bs-theme", "dark"), document.documentElement.setAttribute("data-bs-theme", "dark"), x("data-bs-theme", "dark")) : (sessionStorage.setItem("data-bs-theme", "light"), document.documentElement.setAttribute("data-bs-theme", "light"), x("data-bs-theme", "light"))
            }
            switch (e["data-layout-width"]) {
                ...
                case "boxed":
                    ...
                    break;
                default:
                    "boxed" == sessionStorage.getItem("data-layout-width") ? (sessionStorage.setItem("data-layout-width", "boxed"), document.documentElement.setAttribute("data-layout-width", "boxed"), x("data-layout-width", "boxed")) : (sessionStorage.setItem("data-layout-width", "fluid"), document.documentElement.setAttribute("data-layout-width", "fluid"), x("data-layout-width", "fluid"))
            }
            switch (e["data-sidebar"]) {
                ...
                case "gradient-4":
                    ...
                    break;
                default:
                    sessionStorage.getItem("data-sidebar") && "light" == sessionStorage.getItem("data-sidebar") ? (sessionStorage.setItem("data-sidebar", "light"), x("data-sidebar", "light"), document.documentElement.setAttribute("data-sidebar", "light")) : "dark" == sessionStorage.getItem("data-sidebar") ? (sessionStorage.setItem("data-sidebar", "dark"), x("data-sidebar", "dark"), document.documentElement.setAttribute("data-sidebar", "dark")) : "gradient" == sessionStorage.getItem("data-sidebar") ? (sessionStorage.setItem("data-sidebar", "gradient"), x("data-sidebar", "gradient"), document.documentElement.setAttribute("data-sidebar", "gradient")) : "gradient-2" == sessionStorage.getItem("data-sidebar") ? (sessionStorage.setItem("data-sidebar", "gradient-2"), x("data-sidebar", "gradient-2"), document.documentElement.setAttribute("data-sidebar", "gradient-2")) : "gradient-3" == sessionStorage.getItem("data-sidebar") ? (sessionStorage.setItem("data-sidebar", "gradient-3"), x("data-sidebar", "gradient-3"), document.documentElement.setAttribute("data-sidebar", "gradient-3")) : "gradient-4" == sessionStorage.getItem("data-sidebar") && (sessionStorage.setItem("data-sidebar", "gradient-4"), x("data-sidebar", "gradient-4"), document.documentElement.setAttribute("data-sidebar", "gradient-4"))
            }
            switch (e["data-sidebar-image"]) {
                ...
                case "img-4":
                    ...
                    break;
                default:
                    sessionStorage.getItem("data-sidebar-image") && "none" == sessionStorage.getItem("data-sidebar-image") ? (sessionStorage.setItem("data-sidebar-image", "none"), x("data-sidebar-image", "none"), document.documentElement.setAttribute("data-sidebar-image", "none")) : "img-1" == sessionStorage.getItem("data-sidebar-image") ? (sessionStorage.setItem("data-sidebar-image", "img-1"), x("data-sidebar-image", "img-1"), document.documentElement.setAttribute("data-sidebar-image", "img-2")) : "img-2" == sessionStorage.getItem("data-sidebar-image") ? (sessionStorage.setItem("data-sidebar-image", "img-2"), x("data-sidebar-image", "img-2"), document.documentElement.setAttribute("data-sidebar-image", "img-2")) : "img-3" == sessionStorage.getItem("data-sidebar-image") ? (sessionStorage.setItem("data-sidebar-image", "img-3"), x("data-sidebar-image", "img-3"), document.documentElement.setAttribute("data-sidebar-image", "img-3")) : "img-4" == sessionStorage.getItem("data-sidebar-image") && (sessionStorage.setItem("data-sidebar-image", "img-4"), x("data-sidebar-image", "img-4"), document.documentElement.setAttribute("data-sidebar-image", "img-4"))
            }
            switch (e["data-layout-position"]) {
                ...
                case "scrollable":
                    ...
                    break;
                default:
                    sessionStorage.getItem("data-layout-position") && "scrollable" == sessionStorage.getItem("data-layout-position") ? (x("data-layout-position", "scrollable"), sessionStorage.setItem("data-layout-position", "scrollable"), document.documentElement.setAttribute("data-layout-position", "scrollable")) : (x("data-layout-position", "fixed"), sessionStorage.setItem("data-layout-position", "fixed"), document.documentElement.setAttribute("data-layout-position", "fixed"))
            }
            switch (e["data-preloader"]) {
                case "disable":
                    ...
                    break;
                case "enable":
                    x("data-preloader", "enable"), sessionStorage.setItem("data-preloader", "enable"), document.documentElement.setAttribute("data-preloader", "enable"), (t = document.getElementById("preloader")) && window.addEventListener("load", function() {
                        t.style.opacity = "0", t.style.visibility = "hidden"
                    });
                    break;
                default:
                    var t;
                    sessionStorage.getItem("data-preloader") && "disable" == sessionStorage.getItem("data-preloader") ? (x("data-preloader", "disable"), sessionStorage.setItem("data-preloader", "disable"), document.documentElement.setAttribute("data-preloader", "disable")) : "enable" == sessionStorage.getItem("data-preloader") ? (x("data-preloader", "enable"), sessionStorage.setItem("data-preloader", "enable"), document.documentElement.setAttribute("data-preloader", "enable"), (t = document.getElementById("preloader")) && window.addEventListener("load", function() {
                        t.style.opacity = "0", t.style.visibility = "hidden"
            ...
            switch (e["data-body-image"]) {
                case "none":
                    ...
                    break;
                case "img-1":
                    x("data-body-image", "img-1"), sessionStorage.setItem("data-sidebabodyr-image", "img-1"), document.documentElement.setAttribute("data-body-image", "img-1"), document.getElementById("theme-settings-offcanvas") && document.documentElement.removeAttribute("data-sidebar-image");
                    break;
                case "img-2":
                ...
                case "img-3":
                    ...
                    break;
                default:
                    sessionStorage.getItem("data-body-image") && "none" == sessionStorage.getItem("data-body-image") ? (sessionStorage.setItem("data-body-image", "none"), x("data-body-image", "none"), document.documentElement.setAttribute("data-body-image", "none")) : "img-1" == sessionStorage.getItem("data-body-image") ? (sessionStorage.setItem("data-body-image", "img-1"), x("data-body-image", "img-1"), document.documentElement.setAttribute("data-body-image", "img-1"), document.getElementById("theme-settings-offcanvas") && (document.getElementById("sidebar-img").style.display = "none", document.documentElement.removeAttribute("data-sidebar-image"))) : "img-2" == sessionStorage.getItem("data-body-image") ? (sessionStorage.setItem("data-body-image", "img-2"), x("data-body-image", "img-2"), document.documentElement.setAttribute("data-body-image", "img-2")) : "img-3" == sessionStorage.getItem("data-body-image") ? (sessionStorage.setItem("data-body-image", "img-3"), x("data-body-image", "img-3"), document.documentElement.setAttribute("data-body-image", "img-3")) : "none" == sessionStorage.getItem("data-body-image") && (sessionStorage.setItem("data-body-image", "none"), x("data-body-image", "none"), document.documentElement.setAttribute("data-body-image", "none"))
            }
        }
    }
    ...
    function x(a, e) {
        Array.from(document.querySelectorAll("input[name=" + a + "]")).forEach(function(t) {
            e == t.value ? t.checked = !0 : t.checked = !1, t.addEventListener("change", function() {
                var e;
                document.documentElement.setAttribute(a, t.value), sessionStorage.setItem(a, t.value), p(), "data-layout-width" == a && "boxed" == t.value ? (document.documentElement.setAttribute("data-sidebar-size", "sm-hover"), sessionStorage.setItem("data-sidebar-size", "sm-hover"), document.getElementById("sidebar-size-small-hover").checked = !0) : "data-layout-width" == a && "fluid" == t.value && (document.documentElement.setAttribute("data-sidebar-size", "lg"), sessionStorage.setItem("data-sidebar-size", "lg"), document.getElementById("sidebar-size-default").checked = !0), "data-layout" == a && ("vertical" == t.value ? (k("vertical"), h()) : "horizontal" == t.value ? (document.getElementById("sidebarimg-none") && document.getElementById("sidebarimg-none").click(), k("horizontal")) : "twocolumn" == t.value && (k("twocolumn"), document.documentElement.setAttribute("data-layout-width", "fluid"), document.getElementById("layout-width-fluid").click(), f(), A(), h())), "data-bs-theme" == a && "light" == t.value ? (document.getElementById("topbar-color-light").click(), document.getElementById("sidebar-color-light").click()) : "data-bs-theme" == a && "dark" == t.value && (document.getElementById("topbar-color-dark").click(), document.getElementById("sidebar-color-dark").click()), "data-preloader" == a && "enable" == t.value ? (document.documentElement.setAttribute("data-preloader", "enable"), (e = document.getElementById("preloader")) && setTimeout(function() {
        ...
        }), document.getElementById("collapseLayoutWidth") && (Array.from(document.querySelectorAll('[name="data-body-image"]')).forEach(function(e) {
            var t = document.getElementById("collapseLayoutWidth");
            1 == e.checked && 0 == document.getElementById("data-body-image-none").checked && new bootstrap.Collapse(t, {
                toggle: !1
            }).show(), document.querySelector("[data-bs-target='#collapseLayoutWidth']") && document.querySelector("[data-bs-target='#collapseLayoutWidth']").addEventListener("click", function(e) {
                document.getElementById("data-body-image-2").click()
            })
        }), Array.from(document.querySelectorAll('[data-bs-target="#collapseLayoutWidth.show"]')).forEach(function(e) {
            e.addEventListener("click", function() {
                var e = document.getElementById("collapseLayoutWidth");
                new bootstrap.Collapse(e, {
                    toggle: !1
                }).hide(), document.getElementById("data-body-image-none").click()
            })
        })), Array.from(document.querySelectorAll("[name='data-layout-width']")).forEach(function(e) {
            document.querySelector("[data-bs-target='#collapseLayoutWidth']") && (document.querySelector("#collapseLayoutWidth .form-check input:checked") ? document.querySelector("[data-bs-target='#collapseLayoutWidth']").classList.add("active") : document.querySelector("[data-bs-target='#collapseLayoutWidth']").classList.remove("active"), e.addEventListener("change", function() {
                document.querySelector("#collapseLayoutWidth .form-check input:checked") ? document.querySelector("[data-bs-target='#collapseLayoutWidth']").classList.add("active") : document.querySelector("[data-bs-target='#collapseLayoutWidth']").classList.remove("active")
            }))
        })
    }
    ...
    function C(e, t, a, o) {
        ...
        o.setAttribute(e, t), n && (document.getElementById(a).click(), document.getElementById("sidebar-color-" + t).click(), document.getElementById("topbar-color-" + t).click())
    }
    ...
    sessionStorage.getItem("defaultAttribute") ? ((a = {})["data-layout"] = sessionStorage.getItem("data-layout"), a["data-sidebar-size"] = sessionStorage.getItem("data-sidebar-size"), a["data-bs-theme"] = sessionStorage.getItem("data-bs-theme"), a["data-layout-width"] = sessionStorage.getItem("data-layout-width"), a["data-sidebar"] = sessionStorage.getItem("data-sidebar"), a["data-sidebar-image"] = sessionStorage.getItem("data-sidebar-image"), a["data-layout-position"] = sessionStorage.getItem("data-layout-position"), a["data-layout-style"] = sessionStorage.getItem("data-layout-style"), a["data-topbar"] = sessionStorage.getItem("data-topbar"), a["data-preloader"] = sessionStorage.getItem("data-preloader"), a["data-body-image"] = sessionStorage.getItem("data-body-image"), z(a)) : (i = document.documentElement.attributes, a = {}, Array.from(i).forEach(function(e) {
        var t;
    ...
    }), document.addEventListener("fullscreenchange", H), document.addEventListener("webkitfullscreenchange", H), document.addEventListener("mozfullscreenchange", H), l = document.getElementsByTagName("HTML")[0], document.querySelectorAll("#light-dark-mode .dropdown-item").forEach(function(t) {
        t.addEventListener("click", function(e) {
            l.hasAttribute("data-bs-theme") && "light" == t.getAttribute("data-mode") ? (C("data-bs-theme", "light", "layout-mode-light", l), sessionStorage.setItem("data-layout-auto", "false")) : l.hasAttribute("data-bs-theme") && "dark" == t.getAttribute("data-mode") ? (C("data-bs-theme", "dark", "layout-mode-dark", l), sessionStorage.setItem("data-layout-auto", "false")) : l.hasAttribute("data-bs-theme") && "auto" == t.getAttribute("data-mode") && (window.matchMedia("(prefers-color-scheme: dark)").matches ? C("data-bs-theme", "dark", "layout-mode-dark", l) : C("data-bs-theme", "light", "layout-mode-light", l), sessionStorage.setItem("data-layout-auto", "true")), sessionStorage.getItem("data-layout-auto") && "true" == sessionStorage.getItem("data-layout-auto") ? document.documentElement.classList.add("layout-auto") : document.documentElement.classList.remove("layout-auto")
        })
    }), sessionStorage.getItem("data-layout-auto") && "true" == sessionStorage.getItem("data-layout-auto") ? document.documentElement.classList.add("layout-auto") : document.documentElement.classList.remove("layout-auto"), W(), O(), S(), document.getElementsByClassName("dropdown-item-cart") && (r = document.querySelectorAll(".dropdown-item-cart").length, Array.from(document.querySelectorAll("#page-topbar .dropdown-menu-cart .remove-item-btn")).forEach(function(e) {
        e.addEventListener("click", function(e) {
            r--, this.closest(".dropdown-item-cart").remove(), Array.from(document.getElementsByClassName("cartitem-badge")).forEach(function(e) {
                e.innerHTML = r
            }), N(), document.getElementById("empty-cart") && (document.getElementById("empty-cart").style.display = 0 == r ? "block" : "none"), document.getElementById("checkout-elem") && (document.getElementById("checkout-elem").style.display = 0 == r ? "none" : "block")
        })
    }), Array.from(document.getElementsByClassName("cartitem-badge")).forEach(function(e) {
        e.innerHTML = r
    }), document.getElementById("empty-cart") && (document.getElementById("empty-cart").style.display = "none"), document.getElementById("checkout-elem") && (document.getElementById("checkout-elem").style.display = "block"), N()), document.getElementsByClassName("notification-check") && (M(), Array.from(document.querySelectorAll(".notification-check input")).forEach(function(t) {
        ...
        e && e.addEventListener("hide.bs.dropdown", function(e) {
            ...
            }), M(), document.getElementById("notification-actions").style.display = ""
        })
        ...
        document.getElementById("delete-notification").addEventListener("click", function() {
            ...
            }), M(), document.getElementById("NotificationModalbtn-close").click()
        })
    ...
    }), p(), h(), T(), window.addEventListener("resize", function() {
        c && clearTimeout(c), c = setTimeout(D, 2e3)
    })
}();
